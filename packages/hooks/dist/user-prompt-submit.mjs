...
var PermissionDecisionSchema = external_exports.enum(["allow", "deny", "ask"]);
var HookInputSchema = external_exports.object({
  ...
  tool_input: external_exports.record(external_exports.unknown()).optional(),
  ...
  // matches Rust HookInput.source
  reason: external_exports.string().optional(),
  // matches Rust HookInput.reason
...
// src/lib/fallback.ts
function fallbackUserPromptSubmit(input) {
  ...
  const risk = highRisk.some((k) => prompt.includes(k)) ? "HIGH" : lowRisk.some((k) => prompt.includes(k)) ? "LOW" : "MEDIUM";
  return {
    hookSpecificOutput: {
